...
if __name__ == "__main__":
    ...
    model = VQVAE(vocab_size=4096, z_channels=32, ch=160, test_mode=True, share_quant_resi=4, v_patch_nums=(1, 2, 3, 4, 5, 6, 8, 10, 13, 16))
    model.load_state_dict(torch.load(path))
    # total params: 108.948355 M / 108948355
